...
public class maxSumKxKSubMatrix {
    ...
    public static void main(String[] args) {
        ...
        for(int row=0;row<R;row++){
            for(int col=1;col<=C;col++){  //staring from col=1 as the first col is set as zero as we do in dynamic programming for calculation and to avoid IndexOutOfBoundException
                int curr =in.nextInt();
